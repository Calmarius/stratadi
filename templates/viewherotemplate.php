...
<p class="center"><?php echo xprintf($language['yourheroinvillage'],array('<a href="javascript:void(parent.initMap('.(int)$this->hero['villageX'].','.(int)$this->hero['villageY'].'))">'.$this->hero['villageName'].'</a>'));?></p>
